"""Regenerate kaggle_inria_b3_train.ipynb.
...
if "not found" in gpu_name:
    raise SystemExit("No GPU. Push with: kaggle kernels push -p kaggle_inria_b3 --accelerator gpuT4x2")
...
with io.open("kaggle_inria_b3/kaggle_inria_b3_train.ipynb", "w", encoding="utf-8") as fh:
